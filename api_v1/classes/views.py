...
from . import crud
from .schemas import Classes, CheckAdmin, CheckLes, AddHw, GetHw, GetMembers, AdminAction
...
async def check_admin(data: CheckAdmin,
                      session: AsyncSession = Depends(db_helper.scoped_session_dependency),
                      ):
